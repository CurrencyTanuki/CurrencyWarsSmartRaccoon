...
本项目采用 **CC BY-NC-SA 4.0**（署名-非商业性使用-相同方式共享）国际许可证：任何人均可免费使用、修改和分发本软件，但必须保留版权声明、注明原作者、**禁止任何商业用途**，且**修改后的衍生作品必须以相同许可协议开源**。详见 [LICENSE](LICENSE)。如需商业授权，请联系 QQ 群 726898246。
