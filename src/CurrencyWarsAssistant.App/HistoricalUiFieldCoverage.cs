...
public static class HistoricalUiFieldCoverageRegistry
{
    ...
    private static IReadOnlyList<HistoricalUiFieldCoverage> Build()
    {
        ...
        Add<CompletedRunRecord>(result, "识别诊断", HistoricalUiCoverageDisposition.Diagnostics,
            ...
            nameof(CompletedRunRecord.ArchiveAlgorithmRevision),
        ...
        Add<RunSnapshot>(result, "兼容字段", HistoricalUiCoverageDisposition.ExplicitlyNotDisplayed,
            "专家顾问仅为旧 JSON 兼容保留；不再采集、计算或显示。",
        ...
        Add<Phase2OperationalState>(result, "识别诊断", HistoricalUiCoverageDisposition.Diagnostics,
            ...
            nameof(Phase2OperationalState.FormationSlotObservations),
            nameof(Phase2OperationalState.FormationSlotObservationsArePartial),
            nameof(Phase2OperationalState.FormationSlotObservationsAreAtomic),
            nameof(Phase2OperationalState.FormationSlotTransactionId),
        ...
        Add<FormationCharacterState>(result, "阵容与装备", HistoricalUiCoverageDisposition.HistoricalDetail,
            ...
            nameof(FormationCharacterState.IsCheered),
            nameof(FormationCharacterState.IsHunterStar),
            nameof(FormationCharacterState.SpecialEquipmentIds),
            nameof(FormationCharacterState.SpecialEquipment),
            nameof(FormationCharacterState.CurrentCost));
        ...
        Add<CharacterEquipmentSlotState>(result, "阵容与装备",
            ...
            nameof(CharacterEquipmentSlotState.IsPrivileged),
        ...
        Add<CharacterSpecialEquipmentState>(result, "阵容与特殊装备",
            HistoricalUiCoverageDisposition.HistoricalDetail,
            "特殊装备的唯一身份或视觉候选组均以玩家可读形式显示。",
            nameof(CharacterSpecialEquipmentState.Occupancy),
            nameof(CharacterSpecialEquipmentState.EquipmentId),
            nameof(CharacterSpecialEquipmentState.CandidateEquipmentIds),
            nameof(CharacterSpecialEquipmentState.CandidateDisplayNames),
            nameof(CharacterSpecialEquipmentState.Confidence),
            nameof(CharacterSpecialEquipmentState.FailureReason),
            nameof(CharacterSpecialEquipmentState.CanDriveDecisions));
        Add<CharacterSpecialEquipmentState>(result, "识别诊断",
            HistoricalUiCoverageDisposition.Diagnostics,
            "特殊装备裁剪区域与识别证据用于复核。",
            nameof(CharacterSpecialEquipmentState.Region),
            nameof(CharacterSpecialEquipmentState.Evidence));
        ...
        Add<InventorySlotState>(result, "背包与物品",
            ...
            nameof(InventorySlotState.Quantity));
