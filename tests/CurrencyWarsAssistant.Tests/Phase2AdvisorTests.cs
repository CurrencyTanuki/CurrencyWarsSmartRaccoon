...
public sealed class Phase2AdvisorTests
{
    ...
    [Theory]
    [InlineData("preparation_1_1.jpg", "preparation_generic", 3)]
    [InlineData("preparation_1_2.jpg", "preparation_generic", 7)]
    ...
    public async Task Different169ResolutionKeepsCharacterAndRouteRecognition()
    {
        ...
        Assert.Equal("preparation_generic", result.Snapshot.Stage.Value);
        Assert.Contains(
