...
public sealed class GamePageClassifierTests
{
    ...
    private static readonly (string FixtureFile, string ExpectedPageId)[]
        ...
        [
            ...
            ("preparation_1_1.jpg", "preparation_generic"),
            ("preparation_1_1_after_shop_batch_2048x1152.png", "preparation_generic"),
            ("preparation_1_1_cloudgame_2559x1439.png", "preparation_generic"),
            ...
            ("preparation_1_2.jpg", "preparation_generic"),
    ...
    public void ClassifierRecognizesAllPrivacySafeReplayFrames()
    {
        ...
        foreach (var (fixtureFile, expectedPageId) in ReplayPages)
        {
            ...
            var minimumConfidence = expectedPageId switch
            {
                ...
                "normal_hud" => 0.52,
                // 备战页按页面状态识别（preparation_generic，阈值 0.5），
                // 节点数字走 OCR；不再要求按节点模板的 0.9 高分。
                "preparation_generic" => 0.50,
                _ => 0.90
            };
            Assert.True(
