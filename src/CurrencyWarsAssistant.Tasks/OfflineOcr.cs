...
/// <summary>
/// Exposes an independent secondary recognizer for narrowly-scoped conflict
/// checks. Normal recognition continues to use the primary-first policy.
/// </summary>
public interface ISecondaryOfflineOcr : IOfflineOcr
{
    bool IsSecondaryAvailable { get; }

    ValueTask<OcrTextResult> RecognizeSecondaryAsync(
        CaptureFrame frame,
        PixelRect region,
        CancellationToken cancellationToken);
}
