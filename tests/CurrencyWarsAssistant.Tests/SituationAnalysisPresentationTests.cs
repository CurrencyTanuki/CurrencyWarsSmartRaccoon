...
public sealed class SituationAnalysisPresentationTests
{
    ...
    public void SettlementOperationalFieldsRemainVisibleWhenLegacySnapshotIsUnknown()
    {
        ...
        // 结算金币奖励已废弃（用户 2026-08-06）：不再展示
        Assert.DoesNotContain("奖励金币", presentation.StateSummary, StringComparison.Ordinal);
        ...
        // 结算金币奖励已废弃后，Known 字段 = 结算前三伤害 + 总伤害候选
        Assert.True(presentation.KnownFieldCount >= 1);
