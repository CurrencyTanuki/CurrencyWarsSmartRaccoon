...
public sealed class RunCheckpointTests
{
    ...
    [InlineData("2-4", "2-7", RunResumeDecisionKind.ContinueExisting, "2-6")]
    ...
    [Fact]
    public void SupplyNodeIsSkippedWhenResolvingPreviousCombatNode()
    {
        Assert.True(RunResumePolicy.TryGetPreviousNode("1-6", out var previous));

        Assert.Equal("1-4", previous);
    }
